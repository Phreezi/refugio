...
- **Zoom do jogador** (`src/display/worldZoom.ts`): o zoom da vista é o máximo; pode afastar-se até metade, em níveis inteiros (×4 → ×3 → ×2; ×3 → ×2) para a pixel art continuar exata. **Ao alto** (telemóvel na vertical) o mais perto é um nível abaixo e afasta-se mais um (×4 → ×3, ×2, ×1). **Ctrl + roda** (ou pinça no touchpad) ou +/− no PC — a roda sozinha não faz zoom; pinça com 2 dedos no telemóvel (UIScene).
