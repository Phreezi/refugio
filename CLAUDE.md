...
- [ ] Deploy automático de preview (ex.: GitHub Pages) para testar no telemóvel. **Workflow pronto** (`.github/workflows/deploy.yml`, testado localmente com o build servido em subpasta). Falta: criar o repositório no GitHub, fazer push para `main` e ativar Settings → Pages → Source: GitHub Actions.
