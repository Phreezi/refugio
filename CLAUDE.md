...
- **Corpos**: um inimigo derrotado fica no chão, na posição em que estava, com os **drops** e as flechas que lhe acertaram e não partiram; apanha-se tudo ao passar por cima (co-op: quem passar primeiro) e o corpo desaparece numa nuvem de fumo. Ao fim de `corpseSec` o que ficou passa para uma pilha no chão (nada se perde). Não se gravam.
- **Proteção de principiante**: até às 00:00 do dia `beginnerUntilDay` (4) as armas não gastam usos (aviso no HUD).
