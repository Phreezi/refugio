...
| `fonts/jersey-10-*.woff2` (fonte da interface) | [Jersey 10](https://github.com/scfried/soft-type-jersey) (via Fontsource) | The Soft Type Project Authors | SIL OFL 1.1 (`fonts/Jersey10-OFL.txt`) |
