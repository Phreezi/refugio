...
| `fonts/pixelify-sans-*.woff2`                           | [Pixelify Sans](https://github.com/eifetx/Pixelify-Sans) (via Fontsource) | The Pixelify Sans Project Authors | SIL OFL 1.1 (`fonts/PixelifySans-OFL.txt`) |
| `fonts/tiny5-latin-400-normal.woff2` (só os algarismos) | [Tiny5](https://github.com/Gissio/font_tiny5) (via Fontsource)            | The Tiny5 Project Authors         | SIL OFL 1.1 (`fonts/Tiny5-OFL.txt`)        |
