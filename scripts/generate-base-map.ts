...
// Baú dentro da casa (quarto de betão, junto à parede norte). A fogueira e a bancada são
// construídas pelo jogador (Fase 5; os saves antigos recebem-nas por migração).
